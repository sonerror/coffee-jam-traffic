...
namespace _Game.Scripts.Bus
{
    public class BusStation : MonoBehaviour //also use for edit map
    {
        ...
        */
        ...
        public void DrawBranch()
        {
            ...
            for (int i = 0; i < activeBus.Count; i++)
            {
                ...
                for (int j = 0; j < list.Count; j++)
                {
                    ...
                    {
                        depth = j, end = list[j].transform.position + Vector3.up * 1.12f, start = bus.transform.position + Vector3.up * 1.12f, bus = bus, targetBus = list[j],
                    });
                }
        ...
        private Vector3[] eulerAngle = new Vector3[] { new Vector3(0, 300, 0), new Vector3(0, 30, 0), new Vector3(0, 120, 0), new Vector3(0, 210, 0) };
        [Space(20)]
